...
namespace :notify do
  ...
  task :pingomatic do
    begin
      ...
      XMLRPC::Client.new('rpc.pingomatic.com', '/').call('weblogUpdates.extendedPing', 'akasralikar.github.io' , 'http://akasralikar.github.io', 'http://akasralikar.github.io/atom.xml')
    rescue LoadError
  ...
  task :google do
    begin
      ...
      Net::HTTP.get('www.google.com', '/webmasters/tools/ping?sitemap=' + URI.escape('http://akasralikar.github.io/sitemap.xml'))
    rescue LoadError
  ...
  task :bing do
    begin
      ...
      Net::HTTP.get('www.bing.com', '/webmaster/ping.aspx?siteMap=' + URI.escape('http://akasralikar.github.io/sitemap.xml'))
    rescue LoadError
